...
state(['tipo_trabajo' => 'tesis', 'urgencia' => 1, 'nombre' => '']);

$total = computed(function () {
    $tarifas = ['tesis' => 500, 'auditoria' => 200, 'software' => 800, 'analisis' => 350];
    return $tarifas[$this->tipo_trabajo] * $this->urgencia;
});
...
<div class="bg-white border border-gray-200 rounded-3xl shadow-2xl overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div class="bg-orange-50 p-4 rounded-2xl text-center border-2 border-orange-100">
            ...
            <div class="text-4xl font-black text-gray-900">${{ number_format($this->total, 2) }}</div>
        </div>

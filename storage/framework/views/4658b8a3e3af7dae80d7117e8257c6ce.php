        ...
        <main class="max-w-4xl mx-auto w-full py-12 px-6 flex-grow flex flex-col justify-center">
            ...
            <div class="bg-card-admin p-8 rounded-3xl shadow-2xl border border-gray-800 space-y-8 relative overflow-hidden min-h-[420px] flex flex-col justify-center">
                ...
                <div x-show="!cargando">
                    ...
                    <form action="<?php echo e(route('admin.analizador.procesar')); ?>" 
                          method="POST" 
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any() || session('mensajeError') || session('error')): ?>
                        <div class="bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-bold p-4 rounded-xl flex items-center gap-3 mb-6 animate-[fadeIn_0.3s_ease-out]">
                            ...
                            <span>
                                ...
                                <?php elseif(session('mensajeError')): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('archivoGeneradoUrl')): ?>
                        <div class="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6 animate-[fadeIn_0.5s_ease-out]">
                            <div class="flex items-center gap-4 text-center sm:text-left">
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('ultimoArchivo')): ?>
                                        <p class="text-[10px] text-emerald-500 font-mono mt-1">Ref: <?php echo e(session('ultimoArchivo')); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            
                            <a href="<?php echo e(session('archivoGeneradoUrl')); ?>" download class="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-black px-8 py-4 rounded-xl uppercase tracking-widest shadow-lg transition-all duration-200 active:scale-95 text-center">
                                Descargar Reporte
                            </a>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
</html><?php /**PATH C:\Users\Diurno\Documents\Web_Proyectos\resources\views/admin/analizador.blade.php ENDPATH**/ ?>